...
export const posts: CollectionEntry<Post>[] = [
  ...
  post('job-rice-breeder', 'jobs', ['rice', 'anhui'], '2026-08-10', {
    title: '水稻育种研究员',
    summary:
      '面向水稻新品种选育与材料创制，参与组合鉴定、比较试验和区域试验工作。',
    content:
      '岗位职责：\n\n- 参与水稻亲本材料创制、组合选配与田间鉴定。\n- 协助安排比较试验、区域试验和品种展示，整理田间数据与试验报告。\n- 与科研、生产和推广团队协作，把试验结果转化为可推广品种资料。\n\n任职要求：\n\n- 农学、作物遗传育种或相关专业，本科及以上学历。\n- 了解水稻育种基本流程，能适应田间试验工作。\n- 认真细致，具备团队协作和持续学习能力。\n\n工作地点：安徽。投递方式请见网站联系页面。',
  }),
  post('job-regional-sales', 'jobs', ['rice', 'wheat', 'anhui'], '2026-08-01', {
    title: '区域销售经理',
    summary: '负责区域渠道开拓与品种推广，组织观摩展示，服务经销商与种植户。',
    content:
      '岗位职责：\n\n- 负责指定区域的渠道开拓、维护和品种推广。\n- 组织或配合区域观摩会、示范田和技术培训。\n- 收集市场反馈，协助公司优化品种组合与服务支持。\n\n任职要求：\n\n- 熟悉种子或农资销售，有区域渠道经验者优先。\n- 沟通能力强，能适应出差和农时节奏。\n- 认同公司“良种服务农业，价值奉献社会”的价值取向。\n\n工作地点：安徽及周边区域。投递方式请见网站联系页面。',
  }),
  credentialArticle(
